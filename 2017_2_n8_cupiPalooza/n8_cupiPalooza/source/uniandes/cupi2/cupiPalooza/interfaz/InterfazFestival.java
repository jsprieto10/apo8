...
public class InterfazFestival extends JFrame
{
    ...
    /**
     * Busca una banda en el escenario actual por su cantidad de canciones. <b> post: </b> Se estableció la banda buscada como la banda actual y se muestra en el escenario. Si
    ...
    public void buscarBandaPorCantidadDeCanciones( )
    {
        if( actual != null )
        {
            String cantidad = JOptionPane.showInputDialog( this, "Introduzca la cantidad de canciones", "Buscar banda por cantidad de canciones", JOptionPane.INFORMATION_MESSAGE );
            if(cantidad != null)
            {
                try
                {
        ...
        {
            JOptionPane.showMessageDialog( this, "Debe estar en un escenario para poder realizar una búsqueda", "Buscar Banda Por Cantidad de Canciones", JOptionPane.ERROR_MESSAGE );
        }
